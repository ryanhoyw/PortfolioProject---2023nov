...
-->
	...
	<div class="bg-slate-50 flex flex-col">
	  <div class="self-center flex w-full max-w-[1320px] flex-col items-stretch max-md:max-w-full">
	      ...
	      <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
	        <div class="flex flex-col items-stretch w-[68%] max-md:w-full max-md:ml-0">
	          <div class="z-[1] flex mr-0 w-full justify-between gap-5 my-auto px-5 max-md:max-w-full max-md:flex-wrap max-md:mt-9">
	            <div class="text-zinc-800 text-3xl font-bold leading-[58px] grow shrink basis-auto">
	              Lauren Petersen
	            </div>
	            <div class="self-stretch flex items-center justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
	              <div class="items-stretch flex pt-0 pb-0 justify-between gap-4 my-auto max-md:justify-center">
	                <div class="text-zinc-800 text-lg font-medium leading-7 whitespace-nowrap items-stretch self-center aspect-[1.8571428571428572] my-auto rounded-sm border-b-2 border-b-black border-solid">
	                  Home
	                </div>
	                <div class="bg-black w-px shrink-0 h-10"></div>
	                <div class="text-zinc-800 text-lg font-medium leading-7 self-center my-auto">
	                  Projects
	                </div>
	                <div class="bg-black w-px shrink-0 h-10"></div>
	                <div class="text-zinc-800 text-lg font-medium leading-7 self-center whitespace-nowrap my-auto">
	                  About
	                </div>
	              </div>
	              <div class="text-white text-center text-xl font-medium leading-6 tracking-widest capitalize whitespace-nowrap items-stretch self-stretch grow px-5 py-2.5 rounded-xl">
	                Contact Me
	              </div>
	            </div>
	          </div>
	        ...
	        <div class="flex flex-col items-stretch w-[32%] ml-5 max-md:w-full max-md:ml-0">
	          <div class="bg-purple-300 flex w-[596px] shrink-0 h-[124px] flex-col mx-auto max-md:max-w-full"></div>
	        </div>
	      </div>
	    </div>
	    <div class="max-md:max-w-full">
	      <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
	        <div class="flex flex-col items-stretch w-[42%] max-md:w-full max-md:ml-0">
	          <div class="items-start flex flex-col mt-16 px-5 max-md:max-w-full max-md:mt-10">
	            <div class="text-zinc-800 text-6xl font-bold leading-[77px] self-stretch -mr-5 max-md:max-w-full max-md:text-4xl max-md:leading-[53px]">
	              <span class="">Hello, I'm</span>
	              <span class="">Lauren Peterson</span>
	            </div>
	            <div class="self-stretch text-purple-300 text-xl font-bold leading-7 uppercase -mr-5 mt-8 max-md:max-w-full">
	              <span class="">Front-end Developer | UI/UX Designer</span>
	            </div>
	            <div class="text-zinc-500 text-2xl leading-9 self-stretch -mr-5 mt-8 max-md:max-w-full">
	              Short text with details about you, what you do or your
	              professional career. You can add more information on the about
	              page.
	            </div>
	            <div class="items-stretch flex w-[244px] max-w-full gap-3 mt-8 self-start">
	              <div class="text-zinc-800 text-lg font-medium leading-7 whitespace-nowrap items-center bg-purple-300 grow px-5 py-2 rounded-lg">
	                Projects
	              </div>
	              <div class="text-zinc-800 text-lg font-medium leading-7 whitespace-nowrap items-center border-[color:var(--bg-line,#25282B)] grow px-5 py-2 rounded-lg border-2 border-solid">
	                LinkedIn
	              </div>
	            </div>
	          </div>
	  ...
	  <div class="justify-center items-center bg-slate-50 self-stretch flex w-full flex-col mt-14 pl-11 pr-11 pt-11 pb-24 max-md:max-w-full max-md:mt-10 max-md:px-5">
	    <div class="text-5xl font-extrabold leading-[76px] bg-clip-text whitespace-nowrap max-md:text-4xl max-md:leading-[68px]">
	      About Me
	    </div>
	    <div class="self-stretch mt-10 max-md:max-w-full">
	      <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
	        <div class="flex flex-col items-stretch w-[33%] max-md:w-full max-md:ml-0">
	          <div class="self-stretch bg-white flex grow flex-col w-full mx-auto p-12 rounded-[3.125rem] max-md:max-w-full max-md:mt-5 max-md:px-5">
	            <img
	              loading="lazy"
	            ...
	            />
	            <div class="justify-center text-zinc-700 text-3xl font-medium leading-10 self-stretch mt-6">
	            ...
	            <div class="self-stretch text-zinc-700 text-lg leading-7 mt-3">
	              ...
	              suspendisse turpis cras accumsan. Nibh integer viverra felis magna
	              varius etiam pretium quis ornare. Morbi proin eget dolor volutpat
	              sapien massa mi. Iaculis dolor vitae sit sit nibh. Dignissim at
	              viverra molestie cras et fermentum quis purus. Diam nec elit
	              feugiat euismod amet mi tristique commodo quam. Ac nulla interdum
	              facilisis praesent integer rutrum tristique id feugiat. Ipsum
	              sapien leo eleifend fringilla nulla habitasse. Eget aliquet odio
	              imperdiet faucibus in enim. Elementum dolor nisl sed felis etiam
	              scelerisque.
	              <br />
	        ...
	        <div class="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
	          <div class="self-stretch bg-white flex grow flex-col w-full mx-auto pt-12 pb-20 px-12 rounded-[3.125rem] max-md:max-w-full max-md:mt-5 max-md:px-5">
	            <img
	              loading="lazy"
	              src="https://cdn.builder.io/api/v1/image/assets/TEMP/434ead2d-3861-47f5-ab6b-12015b594002?"
	              class="aspect-square object-contain object-center w-16 justify-center items-center overflow-hidden max-w-full"
	            />
	            <div class="text-zinc-700 text-3xl font-medium leading-10 self-stretch mt-6">
	            ...
	            <div class="self-stretch text-zinc-700 text-lg leading-7 mt-3">
	              ...
	              diam porttitor malesuada ut sagittis.
	              <br />
	              Volutpat cursus donec ultricies aliquet scelerisque quisque. Diam
	              vitae in scelerisque posuere viverra sit sit ultricies gravida.
	              Amet tempor tristique mi donec. Morbi sed eu a ornare etiam morbi.
	        ...
	        <div class="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
	          <div class="self-stretch bg-white flex grow flex-col w-full mx-auto p-12 rounded-[3.125rem] max-md:max-w-full max-md:mt-5 max-md:px-5">
	            ...
	            <div class="self-stretch text-zinc-700 text-lg leading-7 mt-3">
	              ...
	              adipiscing id at dictumst. Pellentesque enim ornare pharetra felis
	              mi tellus purus. Elementum cum facilisis nunc feugiat semper
	              viverra sociis. Pellentesque netus suspendisse sed eget dui est
	              felis. Pellentesque amet urna id id. Posuere senectus vitae dui a
	              semper est sed ornare nunc. Viverra ipsum tristique erat
	              venenatis. Neque in velit odio condimentum id urna mauris. Nam
	              senectus bibendum nunc cursus id diam nibh integer id. Imperdiet
	              scelerisque non at aliquam risus.
	              <br />
	              Risus lorem bibendum in proin faucibus id sagittis. Molestie purus
	              morbi ac eget integer quisque ultrices et. Sociis vitae nibh erat
	              rhoncus. Pulvinar tellus.
	            </div>
	          </div>
	        </div>
	      </div>
	  ...
	  <div class="justify-center items-stretch self-center flex w-[181px] max-w-full flex-col mt-28 px-5 max-md:mt-10">
	  ...
	  <div class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10">
	    <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
	      <div class="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
	        <div class="justify-center bg-white flex grow flex-col w-full mx-auto pl-12 pr-10 py-36 max-md:max-w-full max-md:px-5 max-md:py-24">
	          <div class="self-stretch text-zinc-800 text-4xl font-bold leading-[60px]">
	            Project Name
	          </div>
	          ...
	          <div class="text-zinc-800 text-lg font-medium leading-7 whitespace-nowrap items-center border border-[color:var(--font-high-emphasis,#25282B)] mb-0 w-[150px] max-w-full mt-6 px-5 py-2 rounded-3xl border-solid max-md:mb-2.5">
	            View Project
	          </div>
	        </div>
	      </div>
	  ...
	  <div class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10">
	    <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
	      ...
	      <div class="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
	        <div class="justify-center bg-white flex grow flex-col w-full mx-auto pl-12 pr-10 py-40 max-md:max-w-full max-md:px-5 max-md:py-24">
	          <div class="self-stretch text-zinc-800 text-4xl font-bold leading-[60px]">
	            Project Name
	          </div>
	          <div class="self-stretch text-zinc-500 text-lg leading-7 mt-6">
	  ...
	  <div class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10">
		...
		<div class="justify-center items-center self-center z-[1] flex w-[400px] max-w-full flex-col mt-20 px-5 py-0.5 max-md:mt-10">
			...
			<footer class="justify-center items-center flex flex-col">
				<div name="footer_contact_icon_links" class="justify-center items-start self-center flex w-[258px] max-w-full gap-4 mt-14 max-md:justify-center max-md:mt-10">
					<img
					loading="lazy"
